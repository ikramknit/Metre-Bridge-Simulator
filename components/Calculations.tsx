  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="bg-gray-900/50 p-4 rounded-lg">
        ...
        <p className="text-sm font-mono text-gray-400">1. Unknown Resistance, <code className="text-sky-400">S = R * (100 - l) / l</code></p>
        <p className="text-sm font-mono text-gray-400 mt-1">2. Specific Resistance, <code className="text-sky-400">ρ = (S * π * d²) / (4 * L)</code></p>
      </div>
