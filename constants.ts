...
// It is used internally to calculate the correct balancing point.
export const S_ACTUAL: number = 5.0; // Ohms (Ω)


// OHM'S LAW CONSTANTS
export const OHMS_LAW_WIRE_RESISTANCE_ACTUAL: number = 2.0; // Ohms (Ω)
export const OHMS_LAW_WIRE_LENGTH_ACTUAL: number = 100; // cm
export const BATTERY_EMF: number = 6.0; // Volts (V)
